...
test("it converts dirty svg string to svgo optimized data url", async () => {
  ...
  expect(
    ...
    `data:image/svg+xml,%3Csvg width='26' height='26' viewBox='0 0 26 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' stroke='currentColor' stroke-width='2'%3E%3Ccircle cx='13' cy='9' r='6'/%3E%3Cpath stroke-linecap='round' d='M21.5 22.9c0-4.1-3.9-7.8-8.5-7.8s-8.5 3.4-8.5 7.8'/%3E%3C/g%3E%3C/svg%3E`
  );
});
